question_list =[
    ...
    {"question": "Standard error is obtained through dividing the standard deviation by square root of the sample size", "answer": "True"}, 
    ...
    # {"question": "In an autoregressive model, the lagged dependent variable is included in the independent variable list", "answer": "True"}, 
    # {"question": "In statistical testing, null hypothesis is rejected when p-value is less than significance level", "answer": "True"}, 
    # {"question": "One minus significance level gives the confidence level", "answer": "True"}, 
